...
import CreatePostsForFarmers from '../CreatePostsForFarmer/CreatePostsForFarmer';
...
const FarmerProfile = () => {
  ...
  return (
    ...
    <div className="farmer-profile">
      ...
      <p id='farmer-create-post-heading'>Create Post</p>
      <div className="farmer-create-post">
        <CreatePostsForFarmers/>
      </div>
    </div>
      ...
      <FarmerPosts farmerId={farmer._id}/>
